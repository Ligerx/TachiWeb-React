  ...
  Commands: function() {
    ...
    new ApiCommand('SourceLogin', '/source_login', function(parameters) {
      return (
        ...
        parameters.sourceId +
        '?username=' +
        encodeURIComponent(parameters.username) +
        '&password=' +
    ...
    new ApiCommand('SetFlag', '/set_flag', function(parameters) {
      return (
        this.endpoint() + '/' + parameters.mangaId + '/' + parameters.flag + '/' + parameters.state
      );
    });
    ...
    new ApiCommand('SetPref', '/set_pref', function(parameters) {
      ...
      if (value != null) {
        ...
        if (parameters.type === 'string_set') value = JSON.stringify(value);
