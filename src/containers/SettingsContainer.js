...
import {FETCH_PREFS, FETCH_SCHEMA, fetchSettings, fetchSettingsSchema, setSetting} from "../redux-ducks/settings";
...
const mapStateToProps = (state: { settings: State }, ownProps: Object): StateToProps => {
    if (settingsAreLoading(state) || state.settings.schema == null) return {settingsLoaded: false}
    else return {
        settingsLoaded: true,
