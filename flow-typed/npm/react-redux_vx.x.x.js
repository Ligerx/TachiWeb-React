...
// flow-typed version: <<STUB>>/react-redux_v5.X.X/flow_>=v0.89.x

/**
 * Copied the react-redux_v5.x.x.js flow-typed libdef, then added my own stuff for hooks.
 * This is a temporary solution until the libdef is updated to support v7.1.0
 */
...
declare module "react-redux" {
  // Copied from the typescript definition
  declare export function useSelector<TState, TSelected>(
    selector: (state: TState) => TSelected,
    equalityFn?: (left: TSelected, right: TSelected) => boolean
  ): TSelected;

  // Not using the typescript definition because it requires a bunch of extra
  // work to make it work correctly with thunks.
  declare export function useDispatch(): ({ type: string } | Function) => any;
  // declare export function useDispatch(): Function;
